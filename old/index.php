            ...
            <div class="first-screen__wrapper">
                ...
                <div class="first-screen__bottom">
                    ...
                    <div class="social-list social-list--first-screen wow fadeInRight">
                        <a href="https://www.instagram.com/" class="item item--first-screen">
    ...
    <section class="section work">
        <div class="container">
            ...
            <div class="work__list">
                <a href="/projects/bathroom_design" class="work__item work__item--two-widths wow fadeInUp" data-wow-delay="0s" style="background-image: url(/assets/img/works-list/1.png)">
                ...
                <a href="/projects/bathroom_design" class="work__item wow fadeInUp" data-wow-delay="0.1s" style="background-image: url(/assets/img/works-list/2.png)">
                    <h3 class="work__title">
                ...
                <a href="/projects/bathroom_design" class="work__item wow fadeInUp" data-wow-delay="0.2s" style="background-image: url(/assets/img/works-list/3.png)">
                ...
                <a href="/projects/bathroom_design" class="work__item work__item--only-desktop wow fadeInUp" data-wow-delay="0.1s" style="background-image: url(/assets/img/works-list/4.png)">
                    <h3 class="work__title">
                        Дизайн двухкомнатной в стиле Хай-Текс на Ленинградской
                    </h3>
                    <div class="work__tags">
                        <div class="work__tag">Гостиная</div>
                        <div class="work__tag">Хай-Текс</div>
                        <div class="work__tag">Чертежи</div>
                    </div>
                </a>
                <a href="/projects/bathroom_design" class="work__item work__item--only-desktop wow fadeInUp" data-wow-delay="0.2s" style="background-image: url(/assets/img/works-list/5.png)">
                ...
                <a href="/projects/bathroom_design" class="work__item work__item--only-desktop wow fadeInUp" data-wow-delay="0.1s" style="background-image: url(/assets/img/works-list/6.png)">
                    <h3 class="work__title">
    ...
    <section class="section instagram">
        <div class="container">
            ...
            <p class="instagram__description wow fadeInUp">
                Также мы есть в <a href="https://www.instagram.com/">Instagram</a>, где вы можете посмотреть все наши
